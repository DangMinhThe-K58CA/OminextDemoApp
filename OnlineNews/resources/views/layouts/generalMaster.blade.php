                    ...
                    <!--  -->
                            <div class="dropdown" style="margin-top:1%;">
                                ...
                                <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                    ...
                                    <li><a href="#" onclick = "window.location.href = '/generalInfo'"><i class="fa fa-info-circle" style="font-size:20px;color:green;"></i>   Thông tin</a></li>

                                    <li><a href="#" onclick = "window.location.href = '/generalProfile'"><i class="fa fa-heartbeat" style="font-size:20px;color:blue;"></i>   Bookmark </a></li>
        ...
        <!-- @section('leftNav')
            <div class="col-sm-2">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                        <li><a href="#" onclick="window.location.href = '#'">Bookmark</a></li>
                        <li><a href="#" onclick="window.location.href = 'generalProfile'">Thông tin cá nhân</a></li>
                        <li class="divider"></li>
                    </ul>
                </div>
            </div>
