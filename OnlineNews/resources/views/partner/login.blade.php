    ...
    <div class="row">
        <div class="login-box">
            <div class="well no-padding">
                <form id="loginForm" class="smart-form client-form" novalidate="novalidate" method="POST" action="/partnerLoginProcessing">
                   {{ csrf_field() }}
                    <header>
                        Đăng nhập hệ thống
                    </header>
                    <fieldset>
                        @if ($error != "")
                        <p class="alert alert-warning" id="login-fail">
                    ...
                    <footer>
                        <input type = "button" class="btn btn-danger" onclick="window.location.href = '/partnerLogin'" value = "Hủy"/>
