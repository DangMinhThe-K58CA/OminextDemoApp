              ...
              <div id="edit-profile" class="tab-pane">
                <section class="panel">                                          
                      <div class="panel-body bio-graph-info">
                          ...
                          <form class="form-horizontal" role="form" method="POST" action="/changePartnerInfo">
                    ...
                    <div role="content">
                      <div class="dt-wrapper" id="DtWrapper">
                        <div class="widget-body no-pediting">
                          <form id="changingPasswordForm" action="/changePartnerPassword" class="smart-form" novalidate="novalidate" method="POST">
