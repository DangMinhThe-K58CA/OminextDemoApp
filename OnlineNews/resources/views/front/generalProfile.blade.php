...
<div class="col-sm-12 col-sm-offset-0" ng-app = "personalPageApp">
	...
	<div class="col-sm-12 col-sm-offset-0" id = "categoriesList" ng-controller = "categoryController" >
		<div class="col-xs-12 col-sm-6 col-md-4" ng-repeat = "cate in catesData" >
